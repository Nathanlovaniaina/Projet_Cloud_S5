...
VALUES
(-18.8765, 47.5120, 'Nids de poule Route Digue', 'Plusieurs nids de poule de 30-50cm de diamètre causent des dommages aux véhicules. Zone très fréquentée par les taxis et bus. Risque d''accidents notamment pour les deux-roues. Intervention urgente requise.', 12.50, '2025-02-01 08:30:00', NULL, ST_SetSRID(ST_MakePoint(47.5120, -18.8765), 4326)::geography, NOW(), 1, 1),
(-18.8790, 47.5095, 'Affaissement de chaussée Avenue Indépendance', 'Affaissement progressif de la chaussée sur environ 15 mètres carrés. Présence de fissures en toile d''araignée. La circulation est ralentie et dangereuse, particulièrement pour les poids lourds.', 15.20, '2025-01-30 14:15:00', NULL, ST_SetSRID(ST_MakePoint(47.5095, -18.8790), 4326)::geography, NOW(), 1, 2),
(-18.8810, 47.5140, 'Caniveau bouché quartier Analakely', 'Le caniveau est complètement obstrué par des déchets et de la boue. En période de pluie, l''eau stagne et inonde la chaussée. Risque sanitaire et de dégradation accélérée de la route.', 8.00, '2025-01-28 10:45:00', NULL, ST_SetSRID(ST_MakePoint(47.5140, -18.8810), 4326)::geography, NOW(), 5, 3),
(-18.8825, 47.5105, 'Feu tricolore en panne Ambohijatovo', 'Le feu tricolore ne fonctionne plus depuis 5 jours. La circulation est très perturbée aux heures de pointe. Un agent de police doit réguler mais n''est pas toujours présent. Carrefour à haut risque d''accidents.', 2.00, '2025-01-25 16:20:00', NULL, ST_SetSRID(ST_MakePoint(47.5105, -18.8825), 4326)::geography, NOW(), 3, 4),
(-18.8755, 47.5085, 'Lampadaire défectueux Boulevard Ranavalona', 'Plusieurs lampadaires sont éteints sur un tronçon de 80 mètres. La zone est très sombre la nuit, augmentant l''insécurité pour les piétons et les risques d''agressions.', 3.50, '2025-01-23 09:00:00', NULL, ST_SetSRID(ST_MakePoint(47.5085, -18.8755), 4326)::geography, NOW(), 4, 5),
(-18.8840, 47.5130, 'Trottoir dégradé Rue Rainibetsimisaraka', 'Le trottoir présente de nombreux trous et pavés descellés sur une longueur d''environ 25 mètres. Dangereux pour les piétons, notamment personnes âgées et enfants. Plusieurs chutes signalées.', 25.00, '2025-01-20 11:30:00', NULL, ST_SetSRID(ST_MakePoint(47.5130, -18.8840), 4326)::geography, NOW(), 5, 6),
(-18.8795, 47.5110, 'Route inondée saison des pluies Ambodivona', 'La route devient totalement impraticable pendant la saison des pluies. L''eau stagne pendant plusieurs heures, bloquant la circulation. Nécessite un système de drainage efficace et un rehaussement de la chaussée.', 45.00, '2025-01-18 07:45:00', NULL, ST_SetSRID(ST_MakePoint(47.5110, -18.8795), 4326)::geography, NOW(), 2, 7),
(-18.8770, 47.5150, 'Panneau de signalisation manquant Bypass', 'Le panneau de limitation de vitesse a disparu. Zone à proximité d''une école primaire où les enfants traversent fréquemment. Remplacement urgent nécessaire pour la sécurité des écoliers.', 1.50, '2025-01-15 13:20:00', NULL, ST_SetSRID(ST_MakePoint(47.5150, -18.8770), 4326)::geography, NOW(), 3, 8),
(-18.8850, 47.5075, 'Fissures importantes RN2 entrée Tana', 'Fissures longitudinales et transversales importantes sur la chaussée. Surface totale affectée d''environ 30 m². Risque d''élargissement rapide en saison des pluies. Nécessite réfection complète.', 30.00, '2025-01-12 15:50:00', NULL, ST_SetSRID(ST_MakePoint(47.5075, -18.8850), 4326)::geography, NOW(), 1, 9),
(-18.8780, 47.5125, 'Chaussée défoncée devant marché Andravoahangy', 'Chaussée très détériorée devant le marché avec de nombreux nids de poule et ornières. La boue s''accumule et rend la circulation difficile. Impact économique sur l''activité commerciale du marché.', 18.75, '2025-01-10 08:15:00', NULL, ST_SetSRID(ST_MakePoint(47.5125, -18.8780), 4326)::geography, NOW(), 1, 10),
(-18.8805, 47.5090, 'Pont endommagé quartier Anosibe', 'Le garde-corps du pont présente des sections endommagées. Structure potentiellement fragilisée. Inspection technique urgente requise pour évaluer la sécurité. Forte fréquentation quotidienne.', 10.00, '2025-01-05 10:30:00', NULL, ST_SetSRID(ST_MakePoint(47.5090, -18.8805), 4326)::geography, NOW(), 2, 11),
(-18.8860, 47.5160, 'Route boueuse impraticable à Soavimasoandro', 'Route en terre non bitumée, complètement boueuse et glissante pendant 6 mois de l''année. Les véhicules s''enlisent régulièrement. Population locale isolée. Bitumage nécessaire.', 120.00, '2025-01-02 14:00:00', NULL, ST_SetSRID(ST_MakePoint(47.5160, -18.8860), 4326)::geography, NOW(), 2, 12),
(-18.8820, 47.5115, 'Grille avaloir cassée Ankorondrano', 'La grille de l''avaloir est cassée, laissant un trou béant dangereux pour les piétons et deux-roues. Plusieurs incidents rapportés. Remplacement urgent de la grille nécessaire.', 2.50, '2024-12-28 09:45:00', NULL, ST_SetSRID(ST_MakePoint(47.5115, -18.8820), 4326)::geography, NOW(), 5, 13),
(-18.8745, 47.5135, 'Marquage au sol effacé carrefour Behoririka', 'Le marquage au sol des passages piétons et des lignes de circulation est complètement effacé. Confusion dans la circulation, particulièrement dangereux la nuit et par temps de pluie.', 35.00, '2024-12-25 11:20:00', NULL, ST_SetSRID(ST_MakePoint(47.5135, -18.8745), 4326)::geography, NOW(), 3, 14),
(-18.8875, 47.5100, 'Détérioration voie publique secteur Isotry', 'Dégradation générale de la voie publique nécessitant une intervention de maintenance. Surface affectée d''environ 22 m². Nombreuses plaintes des riverains.', 22.00, '2024-12-20 16:30:00', NULL, ST_SetSRID(ST_MakePoint(47.5100, -18.8875), 4326)::geography, NOW(), 5, 15),
(-18.8800, 47.5145, 'Demande éclairage supplémentaire Rue Andrianary', 'Demande d''installation de lampadaires supplémentaires. Zone déjà couverte par éclairage municipal suffisant selon normes en vigueur.', 0.00, '2024-12-15 08:00:00', NULL, ST_SetSRID(ST_MakePoint(47.5145, -18.8800), 4326)::geography, NOW(), 4, 1),
(-18.8785, 47.5080, 'Signalement duplicata Avenue Rakotomavo', 'Signalement en doublon, déjà traité sous référence antérieure. Aucune action supplémentaire nécessaire.', 0.00, '2024-12-10 12:30:00', NULL, ST_SetSRID(ST_MakePoint(47.5080, -18.8785), 4326)::geography, NOW(), 1, 2);
