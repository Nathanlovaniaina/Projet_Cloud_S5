-- Complementary seed data to expand test coverage for statistics
-- Adds generated signalements, tentative_connexion records and some entreprise assignations
-- Run after your existing `script.sql` and `data-reel.sql` files
